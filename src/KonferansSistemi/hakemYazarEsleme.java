...
for(t=0;t<yazarSayisi();t++) {
	  
	 // t=0;
	  
  
  	if(yazarDepo[t][0].equals("Elektrik")) {
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][0].equals("Elektrik")) {
    				
    				konuID1[boy]=hakemDepo[k][12];
    				
    				boy++;
    			}
    		}
    	}	        	
    	if(yazarDepo[t][1].equals("Elektronik")){
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][1].equals("Elektronik")) {
    	...
    	if(yazarDepo[t][2].equals("Biyomedikal")){	  
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][2].equals("Biyomedikal")) {
    	...
    	if(yazarDepo[t][3].equals("Programlama")){
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][3].equals("Programlama")) {
    	...
    	if(yazarDepo[t][4].equals("Kontrol")){
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][4].equals("Kontrol")) {
    	...
    	if(yazarDepo[t][5].equals("Fizik")){
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][5].equals("Fizik")) {
    	...
    	if(yazarDepo[t][6].equals("Kimya")){
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][6].equals("Kimya")) {
    	...
    	if(yazarDepo[t][7].equals("Matematik")){
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][7].equals("Matematik")) {
    	...
    	if(yazarDepo[t][8].equals("Astrofizik")){
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][8].equals("Astrofizik")) {
    	...
    	if(yazarDepo[t][9].equals("Týp")){
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][9].equals("Týp")) {
    	...
    	if(yazarDepo[t][10].equals("Mekanikdizayn")){
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][10].equals("Mekanikdizayn")) {
    	...
    	if(yazarDepo[t][11].equals("Telekominikasyon")){
    		
    		for(int k=0;k<hakemSayisi();k++) {
    			
    			if(hakemDepo[k][11].equals("Telekominikasyon")) {
    	  ...
    	  System.out.println("**********************************************************************");
    	  for (int i = 0 ; i < konuID1.length ; i++){
    		  int flag = 0;
    		  
	    	  for (int j = 0 ; j < i ; j++){
	    		  if (konuID1[i] == konuID1[j]){
	    			  flag = 1;
	    			  break;
	    		  }
    	 }
    	  ...
    	  if (flag == 0){
    		 ...
    		 idBildiriBilgileri[t][0]=yazarDepo[t][14];
    		 idBildiriBilgileri[t][i]=konuID1[i];
    	  
    		
/*    		 int z = 0;
       	  for(int e=0;e<konuID1.length;e++) {
       		  if(konuID1[e]=="null") {
       			z=e-1;
       			  for(int y=0;y<z;y++) {
       	  ...
       	  /*  		  idBildiriBilgileri[t][0]=yazarDepo[t][14];
       	    		  idBildiriBilgileri[t][y+1]=konuID1[y];
       	    		  System.out.println(idBildiriBilgileri[t][y]);
       	    		  */
       	    	  }
       		  }
       	  }
